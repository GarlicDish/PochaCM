...
<h1 class="mt-4">Order Unit List</h1>
...
<div class="text-center" id="searchPanel" style="padding:10px;">
	<form id="searchForm" name="searchForm" action="/orderUnit?curPage=1&category=${category }&keyword=${keyword }" method="get" >
...
<%@ include file="../layout/orderUnitPaging.jsp" %>
