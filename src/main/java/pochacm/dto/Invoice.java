...
public class Invoice {
	...
	public String toString() {
		return "Invoice [items=" + items + ", updatedAt=" + updatedAt + ", refundReason=" + refundReason
				+ ", referenceId=" + referenceId + ", invoiceNumber=" + invoiceNumber + ", type=" + type + ", status="
				+ status + ", source=" + source + ", location=" + location + ", table=" + table + ", guest=" + guest
				+ ", createdAt=" + createdAt + ", surcharge=" + surcharge + ", tips=" + tips + ", rounding=" + rounding
				+ ", totalExcludeTax=" + totalExcludeTax + ", total=" + total + ", discountExcludeTax="
				+ discountExcludeTax + ", discountTax=" + discountTax + ", shippingCost=" + shippingCost
				+ ", shippingDate=" + shippingDate + ", tax=" + tax + ", taxRate=" + taxRate + ", isPaid=" + isPaid
				+ ", isLiability=" + isLiability + ", memberCode=" + memberCode + ", firstName=" + firstName
				+ ", lastName=" + lastName + ", email=" + email + ", uniqueCode=" + uniqueCode + ", shippingAddress="
				+ shippingAddress + ", billingAddress=" + billingAddress + ", payments=" + payments + "]";
	}
