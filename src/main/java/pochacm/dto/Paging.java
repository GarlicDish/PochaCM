...
public class Paging {
	...
	private String category; //searching category
	private String keyword; //searching keyword
	...
	//디폴트 생성자 - 페이징로직이 완성되지 않는다
		...
		private void makePaging() {
			...
			if ( curPage * listCount > totalCount) {
				endNo = totalCount;
			} else {
	...
	public String toString() {
		return "Paging [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount + ", totalPage="
				...
				+ ", startNo=" + startNo + ", endNo=" + endNo + ", category=" + category + ", keyword=" + keyword + "]";
	}
